...
export const QUALITY_BORDER_CSS: Record<string, string> = {
  ...
  LEGENDARY: "rgba(250,204,21,0.60)",
  MYTHIC:    "rgba(251,146,60,0.65)",
...
export const QUALITY_GLOW_CSS: Record<string, string> = {
  ...
  LEGENDARY: "rgba(250,204,21,0.16)",
  MYTHIC:    "rgba(251,146,60,0.18)",
